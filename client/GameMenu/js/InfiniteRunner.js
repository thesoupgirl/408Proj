...
function GameMode() {
  ...
  this.start = function() {
    ...
    this.checkKeyDown = function(e) {
      ...
      switch (code) {
        case 37:
          if (animalGameObject.canLeft) animalGameObject.input.x = self.baseSpeed * -1;
          break; //Left key
        case 38:
          if (animalGameObject.canTop) animalGameObject.input.y = self.baseSpeed * -1;
          break; //Up key
        case 39:
          if (animalGameObject.canRight) animalGameObject.input.x = self.baseSpeed * 1;
          break; //Right key
        case 40:
          if (animalGameObject.canBottom) animalGameObject.input.y = self.baseSpeed * 1;
          break; //Down key
    ...
    this.checkKeyUp = function(e) {
      ...
      switch (code) {
        case 37:
          if (animalGameObject.input.x <= 0) animalGameObject.input.x = 0;
          break; //Left key
        case 38:
          if (animalGameObject.input.y <= 0) animalGameObject.input.y = 0;
          break; //Up key
        case 39:
          if (animalGameObject.input.x >= 0) animalGameObject.input.x = 0;
          break; //Right key
